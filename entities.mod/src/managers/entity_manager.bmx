...
Type EntityManager Extends BaseManager
	...
	''' <summary>Count all entities that have a specific component.</summary>
	''' <param name="t">The type of component to search for.</param>
	''' <return>Number of entities with the component.</return>
	Method countEntitiesWithComponent:Int(t:ComponentType)
		Return EntityBag(Self._entitiesByComponent.get(t.getId())).getSize()
	End Method
