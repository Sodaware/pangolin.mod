...
Type RectangleRenderRequest Extends AbstractSpriteRequest
	...
	Method toggleBorder:RectangleRenderRequest(show:Byte = True)
		' Call show/hide so any types that override these methods don't break.
		If show Then Self.showBorder() Else Self.hideBorder()
