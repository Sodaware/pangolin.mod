...
Type RenderQueue
	...
	''' <summary>Set the active render camera.</summary>
	Method setCamera:RenderQueue(camera:RenderCamera)
		Self._camera = camera

		Return Self
	End Method

	''' <summary>Get the active render camera.</summary>
	...
	Method add:AbstractRenderRequest(obj:AbstractRenderRequest, name:String = "")
		Assert obj, "Cannot add a null render request"
	...
	Method update(delta:Float)
		...
		' TODO: Why is the camera updated twice?

		' TODO: Remove this one I think.
		' Update the camera
	...
	Method render(delta:Float, clear:Byte = False)
